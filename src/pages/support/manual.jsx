...
export default function UserManual() {
  ...
  useEffect(() => {
    document.title = `${t("support.navbar.manual")} | Mimis accounting`;
  }, [t]);
    ...
    const updatedProduct = {
      ...
      steps: [
        ...
        },
        {
          ...
          image: "/public/img/connection.png",
        },
        {
          name: "4",
          inStock: true,
        ...
        },
        {
          ...
          image: "/public/img/navigation.png",
        },
        {
          name: "7",
          inStock: true,
          ...
          image: "/public/img/monitoreo.png",
        },
        {
          name: "8",
          inStock: true,
